...
import contador from "./contador.js"; // Está importando a função reducer do arquivo contador.js.

const reducer = Redux.combineReducers({ contador }); // Criado uma constante chamada reducer que recebe o retorno da função Redux.combineReducers, que é responsável por combinar os reducers em um único reducer, e recebe como parâmetro o reducer importado do arquivo contador.js.
